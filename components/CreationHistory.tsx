...
import { ClockIcon, ArrowRightIcon, ChatBubbleLeftRightIcon } from '@heroicons/react/24/outline';

export interface Creation {
  id: string;
  name: string;
  data: any; // Changed from HTML string to generic JSON data object
  ...
  return (
    <div className="w-full animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="flex items-center space-x-3 mb-3 px-2">
        ...
        <h2 className="text-xs font-bold uppercase tracking-wider text-zinc-500">Memory Log</h2>
        ...
        {history.map((item) => {
          return (
            <button
              ...
              className="group flex-shrink-0 relative flex flex-col text-left w-48 h-28 bg-zinc-900/50 hover:bg-zinc-800 border border-zinc-800 hover:border-zinc-600 rounded-lg transition-all duration-200 overflow-hidden"
            >
              <div className="p-4 flex flex-col h-full">
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex items-center space-x-1 mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <span className="text-[10px] text-indigo-400">Recall</span>
